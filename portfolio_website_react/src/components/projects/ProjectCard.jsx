...
function ProjectCard({ logo, head, cont, anc, img }) {
  return (
    <div className='group min-h-[310px] w-fit md:w-[fit] lg:w-[900px] select-none text-center md:hover:skew-y-0 hover:scale-95 transition-all duration-500'>     {/*md:text-left  agr vapas left side karna ho */}
        <div className='absolute min-h-[310px] w-fit md:w-[fit] lg:w-[900px] dark:hidden bg-blue-500 rounded-lg border-white group-hover:blur-lg'>
        </div>
          ...
          <a href={anc} target='_blank'>
            <div className='dark:text-slate-300 text-gray-700 md:grid md:grid-cols-2 md:gap-20 cursor-pointer transition-all duration-300'>
                ...
                <div className='max-w-[400px] lg:w-[419px] mt-3'>
                  ...
                  <ArrowForwardIcon className='mt-6 invisible md:group-hover:visible dark:text-[#03c0c6] text-blue-500' sx={{fontSize: '30px'}}></ArrowForwardIcon>
                </div>
