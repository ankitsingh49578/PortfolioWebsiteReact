...
function ProjectCard({ logo, head, cont, anc, img }) {
  return (
    <div className='group min-h-[310px] w-fit md:w-[fit] lg:w-[900px] select-none text-center md:hover:skew-y-0 hover:-skew-y-[3deg] hover:-skew-x-3 transition-all duration-500'>     {/*md:text-left  agr vapas left side karna ho */}
          ...
          <a href={anc} target='_blank'>
            <div className='md:grid md:grid-cols-2 md:gap-20 cursor-pointer group-hover:-translate-y-4 transition-all duration-300'>
                ...
                <div className='max-w-[400px] lg:w-[419px] mt-3'>
                  ...
                  <ArrowForwardIcon className='mt-6 invisible md:group-hover:visible text-[#03c0c6]' sx={{fontSize: '30px'}}></ArrowForwardIcon>
                </div>
