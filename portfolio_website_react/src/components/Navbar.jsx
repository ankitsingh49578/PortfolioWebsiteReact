  ...
  return (
    <div>
      <div data-aos="fade-right" className="flex flex-col md:flex-row text-xl justify-between translate-y-10 md:pl-8 md:pr-8 md:pt-7 left-0 right-0">
        ...
        <div className={`md:static absolute bg-[#212428] md:pb-0 pb-12 md:w-fit w-full md:pl-0 pl-9 -mb-10 mt-16 md:mt-0 pt-8 md:pt-0 left-0 z-[1] md:z-auto transition-all ease-in duration-500 ${isOpen ? '-top-[350px]' : 'top-3'}`}>
